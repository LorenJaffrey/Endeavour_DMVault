...
You are collaborating with **Christian**.
...
Vault absolute path: /home/lorenjaffrey/Dokumente/Repositories/Nimble_Obsidian/Nimble
...
- ✗ WRONG: `/notes/my-note.md`, `/home/lorenjaffrey/Dokumente/Repositories/Nimble_Obsidian/Nimble/file.md`
...
- Located in media folder: `./_Attachments`
- Read with: `Read file_path="_Attachments/image.jpg"`
...
curl -sfo "_Attachments/$img_name" 'URL'
```

Then read with `Read file_path="_Attachments/$img_name"`, and replace the markdown link `![alt](url)` with `![[_Attachments/$img_name]]` in the note.
